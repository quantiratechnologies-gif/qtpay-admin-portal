              ...
              >
                ...
                <TableCell onClick={(e) => e.stopPropagation()} className="cursor-default">
                  <div className="flex items-center gap-1.5 text-xs text-slate-300 font-medium select-none">
                    <Terminal className="h-3.5 w-3.5 text-[#6E6E85]" />
                    <span className="font-semibold text-slate-200 tabular-nums">{(m.terminalsList || []).length}</span>
                    <span className="text-[#A2A2BA] text-[11px]">{isAr ? "نقطة بيع" : "SoftPOS"}</span>
                  </div>
                </TableCell>
